...
func (matcher *AntPathMatcher) setPathSeparator(pathSeparator string) {
	matcher.PathSeparator = pathSeparator
}
...
func (matcher *AntPathMatcher) matches(pattern string, source string) bool {
